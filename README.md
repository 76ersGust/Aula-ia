...
1-Repositório destinado ao armazenamento dos exercícios e atividades desenvolvidos durante as aulas de Python. Os arquivos apresentam práticas de programação, resolução de exercícios e aplicação dos conceitos estudados na disciplina.

2- Repositório destinado ao armazenamento dos exercícios e atividades desenvolvidos durante as aulas de Python. Os arquivos apresentam práticas de programação com as bibliotecas: NumPy, SciPy, Pandas e Matplotlib.
